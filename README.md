...
- [Basics in R](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#basics-in-r)
    - [What are functions in R?](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#what-are-functions-in-r)
    - [What is the meaning of the "->"-operator?](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#what-is-the-meaning-of-the---operator)
    - [Packages in R](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#packages-in-r)
- [Textprocessing](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#text-preprocessing)
    - [First things first: Setting up by installing all necessitities](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#first-things-first-setting-up-by-installing-all-necessitities)
    - [Loading in the data](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#loading-in-the-data)
    - [Creating a corpus](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#creating-a-corpus)
    - [Creating DTM](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#creating-dtm)
    - [Inspection of our Document-Term Matrix](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#inspection-of-our-document-term-matrix)
    - [How are and have US Presidents been talking about specific issues?](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#how-are-and-have-us-presidents-been-talking-about-specific-issues)
    - [Conclusion](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#conclusion)
- [Topic Models](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#topic-models)
    - [Setting Up](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#setting-up)
    - [Re-Using of our DTM](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#re-using-of-our-dtm)
    - [Running an LDA Topic Model](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#running-an-lda-topic-model)
    - [Inspection](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#inspection)
- [Lexical Sentiment Analysis](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#lexical-sentiment-analysis)
    - [Setting Up](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#setting-up-1)
    - [Creating the DTM and Taking Preprocessing Steps](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#creating-the-dtm-and-taking-preprocessing-steps)
    - [The General Inquirer Dictionary](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#the-general-inquirer-dictionary)
    - [Transforming the DictionaryGI list to a quanteda dictionary](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#transforming-the-dictionarygi-list-to-a-quanteda-dictionary)
    - [Adding the word count](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#adding-the-word-count)
    - [Sentiment Score](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#sentiment-score)
    - [Validation, validation, validation!](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#validation-validation-validation)
    - [Creating one's own dictionary](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#creating-ones-own-dictionary)
- [Supervised Machine Learning for Automatic Text Classification](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#supervised-machine-learning-for-automatic-text-classification)
    - [Setting up](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#setting-up-2)
    - [Getting data](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#getting-data)
    - [Creating corpus](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#creating-corpus)
    - [Model Training](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#model-training)
    - [Model Testing](https://github.com/deniseroth97/workshop_comptext2024/blob/main/README.md#model-testing)
